...
export const seedBlueprints = async (userId: string | mongoose.Types.ObjectId): Promise<void> => {
  ...
  const rmData = [
    { code: 'RM_CHICKEN', name: 'Chicken', category: 'Meat', purchaseUnit: 'kg', consumptionUnit: 'gm', conversionFactor: 1000, currentStock: 10000, costPerPurchaseUnit: 200 },
    { code: 'RM_MUTTON', name: 'Mutton', category: 'Meat', purchaseUnit: 'kg', consumptionUnit: 'gm', conversionFactor: 1000, currentStock: 5000, costPerPurchaseUnit: 600 },
    { code: 'RM_PANEER', name: 'Paneer', category: 'Dairy', purchaseUnit: 'kg', consumptionUnit: 'gm', conversionFactor: 1000, currentStock: 10000, costPerPurchaseUnit: 300 },
    { code: 'RM_POTATO', name: 'Potato', category: 'Vegetable', purchaseUnit: 'kg', consumptionUnit: 'gm', conversionFactor: 1000, currentStock: 20000, costPerPurchaseUnit: 30 },
    { code: 'RM_CAULIFLOWER', name: 'Cauliflower', category: 'Vegetable', purchaseUnit: 'kg', consumptionUnit: 'gm', conversionFactor: 1000, currentStock: 10000, costPerPurchaseUnit: 40 },
    { code: 'RM_KOFTA', name: 'Kofta', category: 'Veg', purchaseUnit: 'pcs', consumptionUnit: 'pcs', conversionFactor: 1, currentStock: 100, costPerPurchaseUnit: 10 },
    // B-401 Biryani RMs
  ...
  const sfgData = [
    { code: 'SFG_T602A_ACHARI_PASTE', name: 'Achari Paste', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_CHINESE_BASE', name: 'Chinese Base', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_SOUP_BASE', name: 'Soup Base', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_RUBY_SAUCE', name: 'Ruby Sauce', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_CHILLI_BASE', name: 'Chilli Base', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_BOILED_NOODLES', name: 'Boiled Noodles', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_PIZZA_BASE', name: 'Pizza Base', batchYield: 10, yieldUnit: 'pcs', currentStock: 10, costPerUnit: 10 },
    { code: 'SFG_BURGER_SAUCE', name: 'Burger Sauce', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_COCONUT_CHUTNEY', name: 'Coconut Chutney', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_SAMBHAR', name: 'Sambhar', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_ALOO_MASALA', name: 'Aloo Masala', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_DOSA_BATTER', name: 'Dosa Batter', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_UTTAPAM_BATTER', name: 'Uttapam Batter', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_IDLI_BATTER', name: 'Idli Batter', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_VADA_BATTER', name: 'Vada Batter', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
    { code: 'SFG_BOILED_PASTA', name: 'Boiled Pasta', batchYield: 1000, yieldUnit: 'gm', currentStock: 1000, costPerUnit: 0.1 },
  ...
  const dishData = [
    // KYROZ S-300 Engine V3 Injection
    { name: 'V3 Plain Dosa', price: 120, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Masala Dosa', price: 150, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Butter Dosa', price: 160, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Onion Rava Dosa', price: 170, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Mix-Veg Uttapam', price: 180, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Masala Uttapam', price: 190, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Medu Vada (Single)', price: 80, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Regular Idli (2 Pcs)', price: 100, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    { name: 'V3 Mini Idli (Plate)', price: 110, category: 'South Indian', packagingLogic: { takeaway: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], delivery: [pkgIds['PKG_DOSA_BOX'] || pkgIds['PKG_BIRYANI_CONTAINER']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    ...
    // Biryani Dishes
    { name: 'Chicken Biryani', price: 349, category: 'Indian Curry', packagingLogic: { takeaway: [pkgIds['PKG_BIRYANI_CONTAINER'], pkgIds['PKG_LID'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_BIRYANI_CONTAINER'], pkgIds['PKG_LID'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_SERVING_PLATE']] } },
    ...
    // Mandi Dishes
    { name: 'Chicken White Mandi', price: 399, category: 'Indian Curry', packagingLogic: { takeaway: [pkgIds['PKG_MANDI_CONTAINER'], pkgIds['PKG_FOIL'], pkgIds['PKG_SPOON'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_MANDI_CONTAINER'], pkgIds['PKG_FOIL'], pkgIds['PKG_SPOON'], pkgIds['PKG_CARRY_BAG']], dineIn: [] } },
    { name: 'Mutton White Mandi', price: 599, category: 'Indian Curry', packagingLogic: { takeaway: [pkgIds['PKG_MANDI_CONTAINER'], pkgIds['PKG_FOIL'], pkgIds['PKG_SPOON'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_MANDI_CONTAINER'], pkgIds['PKG_FOIL'], pkgIds['PKG_SPOON'], pkgIds['PKG_CARRY_BAG']], dineIn: [] } },
    ...
    // Tandoor Dishes
    { name: 'Chicken Tikka', price: 299, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Tandoori Chicken Half', price: 349, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Tandoori Chicken Full', price: 599, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Chicken Malai Tikka', price: 329, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Afghani Chicken Half', price: 369, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Afghani Chicken Full', price: 629, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Chicken Seekh Kebab', price: 289, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Al Faham Chicken', price: 649, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    
    // Veg Tandoor
    { name: 'Tandoori Paneer', price: 249, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Tandoori Chaap', price: 229, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Tandoori Momos', price: 199, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    
    { name: 'Malai Paneer', price: 269, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Malai Chaap', price: 249, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    
    { name: 'Hariyali Paneer', price: 259, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Hariyali Chaap', price: 239, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    
    { name: 'Achari Paneer', price: 269, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
    { name: 'Achari Chaap', price: 249, category: 'Tandoor', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },

    { name: 'Aloo Gobhi Matar (Semi-Gravy)', price: 250, category: 'Indian Curry', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_OVAL_VEG_DISH']] } },
    { name: 'Navratan Korma', price: 350, category: 'Indian Curry', packagingLogic: { takeaway: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], delivery: [pkgIds['PKG_TAKEAWAY_CONTAINER'], pkgIds['PKG_CARRY_BAG']], dineIn: [pkgIds['PKG_PREMIUM_DEEP_BOWL']] } },
  ];
  ...
  const dishRecipeMappings: Record<string, { itemModel: string, code: string, quantity: number }[]> = {
    // KYROZ S-300 Engine V3 Injection
    'V3 Plain Dosa': [ { itemModel: 'SemiFinishedGood', code: 'SFG_DOSA_BATTER_S301', quantity: 100 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 5 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Masala Dosa': [ { itemModel: 'SemiFinishedGood', code: 'SFG_DOSA_BATTER_S301', quantity: 100 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 5 }, { itemModel: 'SemiFinishedGood', code: 'SFG_ALOO_MASALA_S302', quantity: 120 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Butter Dosa': [ { itemModel: 'SemiFinishedGood', code: 'SFG_DOSA_BATTER_S301', quantity: 100 }, { itemModel: 'RawMaterial', code: 'RM_BUTTER', quantity: 5 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Onion Rava Dosa': [ { itemModel: 'SemiFinishedGood', code: 'SFG_RAVA_BATTER_S303', quantity: 120 }, { itemModel: 'RawMaterial', code: 'RM_ONION', quantity: 15 }, { itemModel: 'RawMaterial', code: 'RM_GREEN_CHILLI', quantity: 2 }, { itemModel: 'RawMaterial', code: 'RM_FRESH_CORIANDER', quantity: 3 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 8 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Mix-Veg Uttapam': [ { itemModel: 'SemiFinishedGood', code: 'SFG_IDLI_BATTER_S305', quantity: 180 }, { itemModel: 'RawMaterial', code: 'RM_ONION', quantity: 10 }, { itemModel: 'RawMaterial', code: 'RM_TOMATO', quantity: 10 }, { itemModel: 'RawMaterial', code: 'RM_GREEN_CHILLI', quantity: 10 }, { itemModel: 'RawMaterial', code: 'RM_FRESH_CORIANDER', quantity: 10 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 8 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Masala Uttapam': [ { itemModel: 'SemiFinishedGood', code: 'SFG_IDLI_BATTER_S305', quantity: 180 }, { itemModel: 'SemiFinishedGood', code: 'SFG_ALOO_MASALA_S302', quantity: 80 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 8 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 30 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 100 } ],
    'V3 Medu Vada (Single)': [ { itemModel: 'SemiFinishedGood', code: 'SFG_VADA_BATTER_S304', quantity: 70 }, { itemModel: 'RawMaterial', code: 'RM_REFINED_OIL', quantity: 8 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 50 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 120 } ],
    'V3 Regular Idli (2 Pcs)': [ { itemModel: 'SemiFinishedGood', code: 'SFG_IDLI_BATTER_S305', quantity: 100 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 50 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 120 } ],
    'V3 Mini Idli (Plate)': [ { itemModel: 'SemiFinishedGood', code: 'SFG_IDLI_BATTER_S305', quantity: 100 }, { itemModel: 'SemiFinishedGood', code: 'SFG_RED_CHUTNEY_S306', quantity: 40 }, { itemModel: 'SemiFinishedGood', code: 'SFG_COCONUT_CHUTNEY_S307', quantity: 50 }, { itemModel: 'SemiFinishedGood', code: 'SFG_SAMBHAR_S308', quantity: 120 } ],

    // Indian Curry Non-Veg Recipes
    'Desi Handi Chicken': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    'Desi Handi Mutton': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    ...
    'Butter Chicken': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 150 } ],
    'Chicken Changezi': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 } ],
    'Chicken Curry': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    'Chicken Kali Mirch': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 150 } ],
    'Chicken Lababdar': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 150 } ],
    ...
    'Chicken Pasanda': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 150 } ],
    'Chicken Tikka Masala': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 150 } ],
    'Kadhai Chicken': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 150 } ],
    'Murg Hariyali': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 150 } ],
    ...
    'Mutton Bhuna Gosht': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 150 } ],
    'Mutton Curry': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    'Mutton Handi': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    'Mutton Rogan Josh': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 } ],
    'Chicken Nizami Handi': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 150 } ],
    'Saag Chicken': [ { itemModel: 'RawMaterial', code: 'RM_CHICKEN', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 150 } ],
    'Saag Mutton': [ { itemModel: 'RawMaterial', code: 'RM_MUTTON', quantity: 200 }, { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 150 } ],

    // Indian Curry Veg Recipes
    'Aloo Gobhi Matar': [ { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 150 }, { itemModel: 'RawMaterial', code: 'RM_POTATO', quantity: 80 }, { itemModel: 'RawMaterial', code: 'RM_CAULIFLOWER', quantity: 80 } ],
    'Corn Palak Cheese': [ { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 140 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 60 } ],
    'Kadhai Paneer': [ { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 200 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 180 } ],
    'Lehsunia Paneer': [ { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 160 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 40 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 150 } ],
    'Malai Kofta (Ivory)': [ { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 200 }, { itemModel: 'RawMaterial', code: 'RM_KOFTA', quantity: 4 } ],
    'Malai Kofta Red': [ { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 120 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 80 }, { itemModel: 'RawMaterial', code: 'RM_KOFTA', quantity: 2 } ],
    'Mushroom Do Pyaza': [ { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 120 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 80 }, { itemModel: 'RawMaterial', code: 'RM_MUSHROOM', quantity: 120 } ],
    'Palak Paneer': [ { itemModel: 'RawMaterial', code: 'SFG_G203', quantity: 200 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 180 } ],
    'Paneer Butter Masala': [ { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 200 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 180 } ],
    'Paneer Dhaniya Adraki': [ { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 140 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 60 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 150 } ],
    'Paneer Lababdar': [ { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 140 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 60 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 150 } ],
    'Paneer Pasanda': [ { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 160 }, { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 40 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 150 } ],
    'Shahi Paneer': [ { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 200 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 180 } ],
    'Signature Panch-Ratan Curry Veg': [ { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 80 }, { itemModel: 'RawMaterial', code: 'SFG_G202', quantity: 60 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 60 }, { itemModel: 'RawMaterial', code: 'RM_PANEER', quantity: 40 } ],
    'Veg Handi': [ { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 80 }, { itemModel: 'RawMaterial', code: 'SFG_G201', quantity: 60 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 60 } ],
    'Veg Jalfrezi': [ { itemModel: 'RawMaterial', code: 'SFG_G204', quantity: 120 }, { itemModel: 'RawMaterial', code: 'SFG_G205', quantity: 80 } ],
